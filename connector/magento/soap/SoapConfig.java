...
public class SoapConfig implements Serializable {
	...
	public String toString() {
		return "SoapConfig [apiUser=" + apiUser + ", apiKey=" + apiKey + ", remoteHost=" + remoteHost
				+ ", defaultAttributeSetId=" + defaultAttributeSetId + ", defaultRootCategoryId="
