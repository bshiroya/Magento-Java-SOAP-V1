...
public enum ResourcePath {
    ...
    ShoppingCartShippingList("cart_shipping.list"),	
     
    
    ShoppingCartSetPaymentInfo("cart_payment.method"),
    ShoppingCartSetShippingInfo("cart_shipping.method"),
    
	ShoppingCartShippingAdd("cart_shipping.add");
